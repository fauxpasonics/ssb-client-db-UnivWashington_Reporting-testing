...
[copyloaddate] [datetime] NULL CONSTRAINT [DF__UserRole__copylo__534D60F1] DEFAULT (getdate())
)
GO
ALTER TABLE [prodcopystg].[UserRole] ADD CONSTRAINT [PK__UserRole__3214EC0722C11CBC] PRIMARY KEY CLUSTERED  ([Id])
GO

...
[copyloaddate] [datetime] NULL CONSTRAINT [DF__Task__copyloadda__4D94879B] DEFAULT (getdate()),
...
GO
ALTER TABLE [prodcopy].[Task] ADD CONSTRAINT [PK__Task__3214EC071ADC1BAA] PRIMARY KEY CLUSTERED  ([Id])
GO

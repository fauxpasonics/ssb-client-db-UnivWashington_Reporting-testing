...
[copyloaddate] [datetime] NULL CONSTRAINT [DF__Opportuni__copyl__36B12243] DEFAULT (getdate()),
...
GO
ALTER TABLE [prodcopy].[Opportunity] ADD CONSTRAINT [PK__Opportun__3214EC07B02D8F21] PRIMARY KEY CLUSTERED  ([Id])
GO

...
[copyloaddate] [datetime] NULL CONSTRAINT [DF__patron__c__copyl__29572725] DEFAULT (getdate())
)
GO
ALTER TABLE [prodcopy].[patron__c] ADD CONSTRAINT [PK__patron____3214EC075E9B4C9D] PRIMARY KEY CLUSTERED  ([Id])
GO

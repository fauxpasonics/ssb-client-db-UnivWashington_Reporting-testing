...
[copyloaddate] [datetime] NULL CONSTRAINT [DF__user__copyloadda__24927208] DEFAULT (getdate()),
...
GO
ALTER TABLE [prodcopy].[user] ADD CONSTRAINT [PK__user__3214EC071763A809] PRIMARY KEY CLUSTERED  ([Id])
GO

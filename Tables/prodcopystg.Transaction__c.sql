...
[copyloaddate] [datetime] NULL CONSTRAINT [DF__Transacti__copyl__2D27B809] DEFAULT (getdate())
)
GO
ALTER TABLE [prodcopystg].[Transaction__c] ADD CONSTRAINT [PK__Transact__3214EC074F192584] PRIMARY KEY CLUSTERED  ([Id])
GO
